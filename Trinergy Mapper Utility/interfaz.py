import sys, pygame
from TrinergyMapperUtility import main
...
pygame.display.set_caption("Trinergy Mapper Utility")
      ...
      for eventos in pygame.event.get():
         ...
         if eventos.type==pygame.MOUSEBUTTONDOWN:
            ...
            if cursor.colliderect(boton2.rect):
               ...
               pygame.quit()
               quit()
         #en caso de que se aprete la X de la pantalla para que se cierre el juego, esta funcion esta en gran parte del codigo
